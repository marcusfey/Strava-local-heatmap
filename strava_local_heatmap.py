...
def process_dates_parallel(sigma_pixel, origSupertile, 
                    lat_bound_min, lat_bound_max, lon_bound_min, lon_bound_max, 
                    x_tile_min, x_tile_max, y_tile_min, y_tile_max, 
                    zoom, gpx_files_count, 
                    dates, date_lat_lon_data, max_workers=None):
    with concurrent.futures.ProcessPoolExecutor(max_workers=max_workers) as executor:
        args = [
                (sigma_pixel, origSupertile, lat_bound_min, lat_bound_max, lon_bound_min, lon_bound_max, 
                 x_tile_min, x_tile_max, y_tile_min, y_tile_max, 
                 zoom, gpx_files_count, d, date_lat_lon_data_raw)
                for d, date_lat_lon_data_raw in date_lat_lon_data.items()
            ]
...
def process_dates(sigma_pixel, origSupertile, 
    ...
    for d in dates:
        process_dates_1date(sigma_pixel, origSupertile, 
                    lat_bound_min, lat_bound_max, lon_bound_min, lon_bound_max, 
                    x_tile_min, x_tile_max, y_tile_min, y_tile_max, 
                    zoom, gpx_files_count, 
                    d, date_lat_lon_data[d])

def process_wrapper(args):
    sigma_pixel, origSupertile, lat_bound_min, lat_bound_max, lon_bound_min, lon_bound_max, \
    x_tile_min, x_tile_max, y_tile_min, y_tile_max, \
    zoom, gpx_files_count, d, date_lat_lon_data_raw = args
    
    return process_dates_1date(
        sigma_pixel, origSupertile, lat_bound_min, lat_bound_max, lon_bound_min, lon_bound_max, 
        x_tile_min, x_tile_max, y_tile_min, y_tile_max, 
        zoom, gpx_files_count, d, date_lat_lon_data_raw
    )

def process_dates_1date(sigma_pixel, origSupertile, 
                    lat_bound_min, lat_bound_max, lon_bound_min, lon_bound_max, 
                    x_tile_min, x_tile_max, y_tile_min, y_tile_max, 
                    zoom, gpx_files_count, 
                    d, date_lat_lon_data_raw):
    ...
    lat_lon_data4date = np.array(date_lat_lon_data_raw)
...
def main(args: Namespace) -> None:
    ...
    process_dates_parallel(sigma_pixel, origSupertile, 
                    lat_bound_min, lat_bound_max, lon_bound_min, lon_bound_max, 
                    x_tile_min, x_tile_max, y_tile_min, y_tile_max, 
                    zoom, gpx_files_count, 
                    dates, date_lat_lon_data,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--parallel', type=int, default=1,
                        help='run heatmap creation in parallel on n CPU cores (default: 1)')
